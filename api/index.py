...
MATH_QUESTIONS = [
    {
        "content": "If A and B are sets with n(A)=115, n(B)=326, n(A-B)=47, then n(A U B) is:",
        "option_a": "373",
        "option_b": "394",
        "option_c": "47",
        "option_d": "441",
        "correct_option": "A",
        "explanation": "n(AUB) = n(A-B) + n(B) = 47 + 326 = 373."
    },
    {
        ...
        "option_d": "7",
        "correct_option": "A",
        "explanation": "a.b = (2*3) + (1*-4) + (1*2) = 6 - 4 + 2 = 4."
    },
    {
        ...
        "option_d": "e^x + c",
        "correct_option": "A",
        "explanation": "Using integration by parts: (x-1)e^x + c."
    },
    {
    ...
    },
    {
        ...
        "option_d": "1/√2",
        "correct_option": "A",
        "explanation": "sin(15°) = (√3 - 1)/2√2."
    }
]

LR_QUESTIONS = [
    {
        "content": "Series: 2, 6, 18, 54, ... What comes next?",
        "option_a": "108",
        "option_b": "148",
        "option_c": "162",
        "option_d": "216",
    ...
    {
        "content": "Boy in photo: 'He is son of the only son of my mother.' Relation to Suresh?",
        "option_a": "Brother",
        "option_b": "Uncle",
        "option_c": "Cousin",
        "option_d": "Father",
        "correct_option": "D",
        "explanation": "Only son is Suresh himself."
    },
    {
        "content": "Which does NOT belong?",
        "option_a": "Leopard",
        "option_b": "Cougar",
        "option_c": "Elephant",
        "option_d": "Lion",
        "correct_option": "C",
        "explanation": "Elephant is not a feline."
    },
    {
        ...
        "option_d": "Direction",
        "correct_option": "D",
        "explanation": "Compass indicates direction."
    },
    {
        "content": "COMPUTER = RFUVQNPC. MEDICINE = ?",
        "option_a": "EOJDJEFM",
        "option_b": "EOJDEJFM",
        "option_c": "MFEJDJOE",
        "option_d": "MFEDJJOE",
        "correct_option": "A",
        "explanation": "Shifted alphabet pattern."
    }
]
